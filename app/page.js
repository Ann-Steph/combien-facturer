      ...
      <main>
        <section className="max-w-6xl mx-auto px-6 pt-12 pb-12 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-start">
          <div>
            ...
            <p className="mt-5 text-lg text-slate-600 leading-8">
              Entre tes objectifs de revenu, tes charges et ton rythme de travail. L’outil estime un tarif
              journalier cohérent pour ton activité freelance.
            </p>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              <FeatureMini
                ...
                title="Tarif estimé"
                text="Un repère concret pour fixer tes prix."
              />
              <FeatureMini
                icon={<BarChart3 size={18} />}
                title="Écart identifié"
                text="Sais si tu es sous-payée."
              />
              <FeatureMini
                icon={<ShieldCheck size={18} />}
                title="Simple"
                text="Aucune connaissance technique."
              />
            </div>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-6 pb-16">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 text-sm text-slate-600 leading-7 flex gap-3">
            ...
            <p>
              Cette estimation est calculée à partir des informations que tu saisis. Elle donne un point de départ utile,
              mais ne remplace pas une analyse complète du marché, de ton expérience ou de ton positionnement.
            </p>
          </div>
        </section>
      </main>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-600 mt-2 leading-6">
          Remplis les champs ci-dessous. Chaque donnée sert à calculer le tarif journalier dont tu as besoin
          pour atteindre ton revenu mensuel.
        </p>
      </div>
  ...
  return (
    <div className="rounded-3xl bg-slate-900 text-white p-6 space-y-5">
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="rounded-full bg-emerald-400 px-3 py-1 text-sm font-medium text-slate-950">
          Débloqué
        </span>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-2xl bg-emerald-400 text-slate-950 p-4">
          ...
          <p className="text-sm leading-6">
            Pour mieux refléter la valeur de mon accompagnement et le niveau de résultat attendu, mon tarif évolue à{" "}
            <strong>{formatEuro(results.tjm)}</strong> par jour.
          </p>
        </div>
      </div>
    </div>
